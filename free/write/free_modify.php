...
<?php    
                ...
                $userID = $_GET['userID']; //받아온 사용자 정보
                $ID = $_GET['ID']; //번호

                $query = $connect->prepare("SELECT title, content, date, userID FROM freeBoard WHERE ID = ?");
                ...
                $usrid = $rows['userID']; // mysql에서 가져온 사용자 정보
        ...
        ?>
        <form method = "get" action = "fb_modify_action.php">
