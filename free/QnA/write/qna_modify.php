...
<?php    
                ...
                $ID = $_GET['ID']; //번호
                $query = $connect->prepare("SELECT title, content, date, userID from QnA where ID= ?");
                ...
                $usrid = $rows['userID']; // 구별 쉽게 usrid로 함. 바꾸면 X.
        ...
        ?>
        <form method = "get" action = "qna_modify_action.php">
